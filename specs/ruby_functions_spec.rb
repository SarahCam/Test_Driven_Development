...
class Functions_Practice < MiniTest::Test
  ...
  def test_fahrenheit_to_celsius()
    ...
    #
    # celsius_1 = fahrenheit_to_celsius( 70 )
    celsius_2 = fahrenheit_to_celsius( 100 )
    # assert_equal( 21, celsius_1 )
    assert_equal( 37.8, celsius_2 )
  end
